...
from discretax.channel_mixers.base import ChannelMixerConfig
from discretax.encoder.base import Encoder, EncoderConfig
from discretax.heads.base import Head, HeadConfig
from discretax.sequence_mixers.base import SequenceMixerConfig
from discretax.utils import count_params
...
class SSM[ConfigType: SSMConfig](eqx.Module):
    ...
    base implementation for all SSM variants in discretax.
